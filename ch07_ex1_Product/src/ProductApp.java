...
public class ProductApp {
    ...
    public static void main(String args[]) {
        ...
        while (choice.equalsIgnoreCase("y")) {
            ...
            //Product product = ProductDB.getProduct(productCode); This is how you would call if it were static
            ...
            System.out.println("Price2:      " + product.getPriceNumberFormatted());
            System.out.println();
